    ...
    <div id="main">
        ...
        <div class="content-footer">
            ...
            <form action="" method="post">
                <div class="text">
                    回复内容:<textarea id="userremark" rows="2" cols="20" ></textarea>
                </div>
                <div class="text" id="sumbtn-foot">
                    <input class="sumbtn" type="button" onclick="cancelorder()" value="取消订单" />
                </div>
            </form>
        </div>
    </div>
...
<script src="../../js/order/myorderdetail.js" type="text/javascript"></script>
</body>
</html>